const fs = require('fs');
const html = fs.readFileSync('public/frontend/acc-out.html', 'utf8');
...
.modal form {
  ...
  fs.writeFileSync('public/frontend/acc-out.html', resultHtml);
  console.log('Successfully patched acc-out.html');
} else {
