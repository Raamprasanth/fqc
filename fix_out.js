...
let content = fs.readFileSync('public/frontend/out.html', 'utf8');
const scriptRegex = /<script>[\s\S]*?<\/script>/;
content = content.replace(scriptRegex, \`<script>\${scriptContent}</script>\`);
fs.writeFileSync('public/frontend/out.html', content);
console.log('out.html fixed completely');
