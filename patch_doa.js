const fs = require('fs');
const html = fs.readFileSync('public/frontend/doa-wf.html', 'utf8');
...
.modal form {
  ...
  fs.writeFileSync('public/frontend/doa-wf.html', resultHtml);
  console.log('Successfully patched doa-wf.html');
} else {
