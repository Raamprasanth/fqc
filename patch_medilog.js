...
let html = fs.readFileSync('public/frontend/medilog.html', 'utf8');
...
// Remove placeholders in inputs/textareas
html = html.replace(/ placeholder="[^"]*"/g, '');

fs.writeFileSync('public/frontend/medilog.html', html);
console.log('Successfully patched medilog.html');
