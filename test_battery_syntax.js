  ...
  const HEALTH_OPTIONS = ['Good', 'Faulty', 'Discharged', 'Replaced', 'Unknown'];
  const SUB_DIVISIONS = ['Ventilator', 'Anesthesia', 'Monitors', 'Ganshorn', 'Other'];
  const divisions = {
    'shipl': {
      label: 'SHIPL',
      fields: [
        {key:'fgDate', label:'FG Date', type:'date'},
        {key:'batteryChargingDate', label:'Battery Charging Date', type:'date'},
        {key:'batteryChargingPeriodMonth', label:'Battery Charging Period in Month', type:'text'},
        {key:'model', label:'Model', type:'text'},
        {key:'unitSn', label:'Unit S/N', type:'text'},
        {key:'conf', label:'Conf', type:'text'},
        {key:'version', label:'Version', type:'text'},
        {key:'totalQty', label:'Total Qty', type:'number'},
        {key:'batteryFunctionalStatus', label:'Battery & Functional Status', type:'select', options:HEALTH_OPTIONS},
        {key:'problemObserved', label:'Problem Observed', type:'textarea'},
        {key:'unitReturnDate', label:'Unit Return Date', type:'date'},
        {key:'remarks', label:'Remarks', type:'textarea'},
      ]
    },
    'ag-monitors-vent-anesthesia-ganshorn': {
      label: 'Schiller AG, Monitors, Ventilator, Anesthesia & Ganshorn',
      fields: [
        {key:'dateOfTesting', label:'Date of Testing', type:'date'},
        {key:'division', label:'Division', type:'select', options:SUB_DIVISIONS},
        {key:'model', label:'Model', type:'text'},
        {key:'unitSn', label:'Unit S.N', type:'text'},
        {key:'conf', label:'Conf', type:'text'},
        {key:'version', label:'Version', type:'text'},
        {key:'batteryStatus', label:'Battery Status', type:'select', options:HEALTH_OPTIONS},
        {key:'functionalStatus', label:'Functional Status', type:'select', options:HEALTH_OPTIONS},
        {key:'cabinetStatus', label:'Cabinet Status', type:'select', options:HEALTH_OPTIONS},
        {key:'remarks', label:'Remarks', type:'textarea'},
      ]
    }
  };
  ...
  let currentDivision = 'ag-monitors-vent-anesthesia-ganshorn';
  const lDiv = activeDivision.toLowerCase();
  if (lDiv.includes('shipl')) {
